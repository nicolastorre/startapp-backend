...
export class InitDB1724251703120 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "resource" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_393a07f6ade7de4dc20fdf00008" PRIMARY KEY ("uuid"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."permission_action_enum" AS ENUM('READ', 'WRITE', 'EDIT', 'DELETE', 'PUBLISH')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."permission_role_enum" AS ENUM('ROOT', 'ADMIN', 'EDITOR', 'AUTHOR', 'CONTRIBUTOR', 'USER')`,
    );
    await queryRunner.query(
      `CREATE TABLE "permission" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "action" "public"."permission_action_enum" NOT NULL DEFAULT 'READ', "conditions" json, "role" "public"."permission_role_enum" NOT NULL DEFAULT 'USER', "userUuid" uuid, "resourceUuid" uuid, CONSTRAINT "PK_972bbdc048bf5d859b99488607e" PRIMARY KEY ("uuid"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "permission" ADD CONSTRAINT "FK_5ae731de4e4d46ff7cc62ce8db8" FOREIGN KEY ("userUuid") REFERENCES "user"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "permission" ADD CONSTRAINT "FK_5979a1419f63360208ce4b9597f" FOREIGN KEY ("resourceUuid") REFERENCES "resource"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "article" ADD CONSTRAINT "FK_a07c1965ebfd4f5bf4473db3aad" FOREIGN KEY ("resourceUuid") REFERENCES "resource"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "article" DROP CONSTRAINT "FK_a07c1965ebfd4f5bf4473db3aad"`,
    );
    await queryRunner.query(
      `ALTER TABLE "article" DROP CONSTRAINT "FK_d6418c7438d3b6f7c00d6db1ede"`,
    );
    await queryRunner.query(
      `ALTER TABLE "permission" DROP CONSTRAINT "FK_5979a1419f63360208ce4b9597f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "permission" DROP CONSTRAINT "FK_5ae731de4e4d46ff7cc62ce8db8"`,
    );
    await queryRunner.query(
